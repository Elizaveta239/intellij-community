 ...
 */
public class AcquireBegin extends DrawElement {

  public AcquireBegin(Color color) {
    super(color);
  }
  ...
  public void drawElement(Graphics g, int padding) {
    ...
    g2.setStroke(new BasicStroke(GraphSettings.STROKE_BASIC));
    g2.setColor(GraphSettings.USE_STD_COLORS ? GraphSettings.LOCK_WAIT_COLOR: myColor);
